...
export default {
  setup() {
      ...
      const handleRegister = () => {
          ...
          console.log("Registering:", { fullname: fullname.value, teacherId: teacherId.value, password: password.value });
      ...
      const handleLogin = () => {
          ...
          console.log("Logging in with:", { teacherId: teacherId.value, password: password.value });
      };
