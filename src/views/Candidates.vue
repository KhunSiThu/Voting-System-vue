...
export default {
    ...
    setup() {
        ...
        let voteWholeKing = ref(localStorage.getItem("voteWholeKing"));
        let voteWholeQueen = ref(localStorage.getItem("voteWholeQueen"));
        ...
        const confirmVote = async (selectedCandidate) => {
            ...
            const collectionName = selectedCandidate.gender === "male" ? "vote-whole-king" : "vote-whole-queen";
