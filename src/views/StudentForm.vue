...
export default {
    setup() {
        ...
        const handleRegister = () => {
            ...
            console.log("Registering:", { fullname: fullname.value, rollNo: rollNo.value, password: password.value });
        ...
        const handleLogin = () => {
            ...
            console.log("Logging in with:", { rollNo: rollNo.value, password: password.value });
        };
