        ...
        <div class="w-full max-w-lg p-8 sm:p-10 ">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <div class="flex justify-center mb-6">
                    <label for="profile-image" class="cursor-pointer">
                        <div class="w-40 h-40 md:h-60 md:w-60  flex justify-center items-center overflow-hidden bg-gray-200 ">
                            <img v-if="imagePreview" :src="imagePreview" alt="Profile Preview" class="w-full h-full object-cover border-4 border-blue-400" />
                            <img v-else src="https://cdn-icons-png.flaticon.com/512/4211/4211763.png" alt="Default Profile" class="w-full h-full object-cover p-10 opacity-40 hover:opacity-100 border-dashed  border-4 border-gray-400 overflow-hidden" />
                        </div>
                    </label>
                ...
                <div class="text-center">
                    <button type="submit" class="w-full px-6 py-3 bg-blue-400 text-white font-semibold rounded-lg hover:bg-blue-600 focus:outline-none transition duration-300" :disabled="!imageFile">
