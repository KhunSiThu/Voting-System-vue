...
<nav class="inline-flex mb-3 sm:hidden w-full bg-gray-200 dark:bg-gray-800 sticky top-0 z-30 shadow-b-lg">
  ...
  <aside id="cta-button-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-4 font-medium">
            ...
            <li>
               <router-link :to="{name:''}" onclick="openlogoutModal()" class="flex items-center p-3 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
      ...
      <button 
        ...
        class="absolute top-5 right-5 bg-gray-800 text-white p-2 rounded-full dark:bg-gray-300 dark:text-gray-900">
