    ...
    <div class="h-full overflow-y-auto bg-gray-50 dark:bg-gray-800 ">
      <div class="flex items-center gap-4  px-2 py-5 border-b m-1">
        ...
        <div class="font-medium dark:text-white">
          ...
          <div class="text-sm text-gray-500 dark:text-gray-400">{{ userData.email }}</div>
        </div>
      </div>
      ...
      <div id="dropdown-cta" class="p-4 m-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
