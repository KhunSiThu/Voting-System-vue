<template>
    <section v-if="votingEnd"
        class="h-1/2  flex flex-row justify-center items-center p-8 md:p-12 bg-white dark:bg-gray-800 dark:text-gray-200">
        <!-- Voting End Section -->
    ...
    <section v-else id="countdown"
        class="bg-white h-1/2 dark:bg-gray-800 p-5 md:p-20 sm:p-20 text-center flex items-center justify-center ">
            ...
            <div class="block md:flex sm:flex justify-between md:justify-center sm:justify-center gap-10">
                <div class="flex gap-6 justify-between mb-5">
                    ...
                    <div class="circle">
                        <svg width="120" height="120">
                            ...
                            <circle :stroke-dasharray="remainingDays * 3.14 + ',' + 314" id="progress-days" class="progress"
                                cx="60" cy="60" r="50" stroke="#FFD700">
                            </circle>
                        </svg>
                        <div class="label">
                    ...
                    <div class="circle">
                        <svg width="120" height="120">
                            <circle class="background" cx="60" cy="60" r="50"></circle>
                            <circle :stroke-dasharray="remainingHours * 3.14 + ',' + 314" id="progress-hours" class="progress"
                                cx="60" cy="60" r="50" stroke="#1E90FF">
                            </circle>
                        </svg>
                        <div class="label">
                ...
                <div class="flex gap-6 justify-between">
                    ...
                    <div class="circle">
                        <svg width="120" height="120">
                            <circle class="background" cx="60" cy="60" r="50"></circle>
                            <circle :stroke-dasharray="remainingMinutes * 3.14 + ',' + 314" id="progress-minutes"
                                class="progress" cx="60" cy="60" r="50" stroke="#32CD32">
                            </circle>
                        </svg>
                        <div class="label">
                    ...
                    <div class="circle">
                        <svg width="120" height="120">
                            <circle class="background" cx="60" cy="60" r="50"></circle>
                            <circle :stroke-dasharray="remainingSeconds * 3.14 + ',' + 314" id="progress-seconds"
                                class="progress" cx="60" cy="60" r="50" stroke="#FF4500">
                            </circle>
                        </svg>
                        <div class="label">
